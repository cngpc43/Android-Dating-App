    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new UserAdapter(user_manage.this, usersArrayList);
        ...
        if (auth.getCurrentUser() == null) {
            Intent intent = new Intent(user_manage.this, login.class);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                user_selected.setBackground(ContextCompat.getDrawable(user_manage.this, R.drawable.selected_nav_item));
            }
        });
        ...
        message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                chat_selected.setBackground(ContextCompat.getDrawable(user_manage.this, R.drawable.selected_nav_item));
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                chat_selected.setBackground(null);
                user_selected.setBackground(null);
                home_selected.setBackground(ContextCompat.getDrawable(user_manage.this, R.drawable.selected_nav_item));
            }
        });
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                loadFragment(new NotificationFragment(user_manage.this));
                title.setText("Notifications");
                home_selected.setBackground(null);
                chat_selected.setBackground(null);
                user_selected.setBackground(null);
                noti_selected.setBackground(ContextCompat.getDrawable(user_manage.this, R.drawable.selected_nav_item));
            }
        });
    }
