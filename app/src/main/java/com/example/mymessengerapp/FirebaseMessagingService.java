...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            if (remoteMessage.getData().get("type") != null && remoteMessage.getNotification() != null) {
    ...
    private void sendNotification(String messageBody, RemoteMessage remoteMessage) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(R.drawable.heart_love_like_favourite_follow_svgrepo_com)
                        .setContentTitle("Tindeo")
